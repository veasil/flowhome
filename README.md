...
> **项目状态｜2026-09-19**  
> 已有独立发布的演示原型。本 GitHub 仓库当前交付产品方案与研究设计文档，尚未同步应用源码、模拟数据生成器或实验结果。下文的标准城市规模是验收目标，不是已核验的运行数据。演示中的人物、价格、交易和承诺均为模拟；不代表真实服务或经营成效。
...
当前仓库未包含上述完整数据集，也没有“B2 已胜出”的实验结论。准确规模应由未来运行的数据清单计算并展示。
...
当前文档无需安装依赖，直接在 GitHub 阅读即可。应用运行命令将在源码同步并验证后补充；现阶段不提供未经验证的启动方式。
